...
_FALLBACK_MODEL_CFG = {
    ...
    'seq_top_k': 50,
    'seq_causal': False,
    'target_aware_query': False,
    'query_generator_type': 'mlp',
    'mind_routing_iters': 3,
    'use_domain_embedding': False,
    'use_attention_bias': False,
    'use_explicit_cross_head': False,
    'action_num': 1,
...
def resolve_model_cfg(train_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for key in _MODEL_CFG_KEYS:
        ...
        elif key == 'query_generator_type' and 'generator_type' in train_config:
            # Backward-compatible alias for earlier experiment configs.
            cfg[key] = train_config['generator_type']
        elif key == 'mind_routing_iters' and 'routing_iters' in train_config:
            # Backward-compatible alias for earlier experiment configs.
            cfg[key] = train_config['routing_iters']
        else:
            cfg[key] = _FALLBACK_MODEL_CFG[key]
            logging.warning(
